...
keywords: ["scrollViewportByStep", "@veltra/utils", "scroll-viewport-by-step", "按视口比例步长平滑水平滚动容器"]
aliases: ["scroll-viewport-by-step", "scrollViewportByStep", "按视口比例步长平滑水平滚动容器"]
---
## 快速上手
