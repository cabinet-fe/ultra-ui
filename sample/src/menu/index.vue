...
const menus = shallowRef<any[]>([
  { title: "首页", icon: HouseFilled, path: "/" },
  {
    ...
    children: [
      {
        title: "用户管理asdasdasd1",
        icon: HouseFilled,
        path: "/view/index/",
        children: [
          { title: "用户管理1-1", icon: HouseFilled, path: "/view/index" },
          { title: "用户管理1-2", icon: Layers, path: "/view/index/123" },
          { title: "用户管理1-3", icon: Usergroup, path: "/view/index/12322" },
          { title: "用户管理1-4", icon: Lock, path: "/view/index/123555" },
          { title: "用户管理1-5", icon: Cart, path: "/view/index/444" },
        ],
      },
