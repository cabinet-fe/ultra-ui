...
const menus = shallowRef<any[]>([
  ...
  { title: '功能模块管理', icon: Users, path: '/business-center/modules' },

  { title: '数据字典', icon: ShoppingCart, path: '/business-center/dict' },
  { title: '用户管理', icon: ShoppingCart, path: '/business-center/user' },
  { title: '单位管理', icon: ShoppingCart, path: '/business-center/unit' },
  { title: '部门管理', icon: ShoppingCart, path: '/business-center/dept' },
  { title: '编码规则', icon: Lock, path: '/business-center/code-rule' },
  {
    ...
    children: [
      ...
      { title: '角色管理', icon: ShoppingCart, path: '/business-center/role/2' },
      { title: '数据字典', icon: ShoppingCart, path: '/business-center/role/3' },
      {
        title: '用户管理',
        icon: ShoppingCart,
        ...
        children: [
          ...
          { title: '数据字典', icon: ShoppingCart, path: '/business-center/role/4/3' },
          { title: '用户管理', icon: ShoppingCart, path: '/business-center/role/4/4' },
          { title: '单位管理', icon: ShoppingCart, path: '/business-center/role/4/5' },
          { title: '部门管理', icon: ShoppingCart, path: '/business-center/role/4/6' },
          { title: '编码规则', icon: Lock, path: '/business-center/role/4/7' }
        ]
      },
      { title: '单位管理', icon: ShoppingCart, path: '/business-center/role/5' },
      { title: '部门管理', icon: ShoppingCart, path: '/business-center/role/6' },
