 ...
 * @returns
 */
async function write(ctx, content, ext) {
...
export function renderVueFile(ctx) {
...
export function renderTypeFile(ctx) {
    const upperCamelCase = str(ctx.componentName).camelCase('upper');
...
export function renderIndexFile(ctx) {
    const upperCamelCase = str(ctx.componentName).camelCase('upper');
    const content = `
...
export function renderStyleFile(ctx) {
    const scssContent = `
  @use 'mixins' as m;
  @use 'functions' as fn;
  @use 'vars';
