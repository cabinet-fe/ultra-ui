...
export class SheetGrid {
  ...
  constructor(options: SheetGridOptions) {
    ...
    // table 创建后才能登记（编辑器 hook 以 table 反查所属 grid）
    gridByTable.set(this.table, this)
  ...
  // ─── 编辑器单例路由（@internal：仅供模块级 formulaAwareEditor 经 gridByTable 调用）───
