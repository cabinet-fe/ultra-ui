...
import type { CellData, CellValue } from '@veltra/sheet-core/core/cell-store.js'
import type { HistoryState } from '@veltra/sheet-core/core/command/history.js'
import type { ImageUpdateFields } from '@veltra/sheet-core/core/command/image.js'
import type { SetCellValueItem } from '@veltra/sheet-core/core/command/set-cell-value.js'
import type { ImageInput, SheetImage } from '@veltra/sheet-core/core/image.js'
import type { CellInfo } from '@veltra/sheet-core/core/merge-manager.js'
import type { SelectionState } from '@veltra/sheet-core/core/selection.js'
import type { FrozenState, Sheet } from '@veltra/sheet-core/core/sheet.js'
import type { CellStyle, CellStylePatch } from '@veltra/sheet-core/core/style/types.js'
