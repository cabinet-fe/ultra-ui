...
import type { CellData, CellValue } from '@veltra/sheet-core/core/cell-store'
import type { HistoryState } from '@veltra/sheet-core/core/command/history'
import type { ImageUpdateFields } from '@veltra/sheet-core/core/command/image'
import type { SetCellValueItem } from '@veltra/sheet-core/core/command/set-cell-value'
import type { ImageInput, SheetImage } from '@veltra/sheet-core/core/image'
import type { CellInfo } from '@veltra/sheet-core/core/merge-manager'
import type { SelectionState } from '@veltra/sheet-core/core/selection'
import type { FrozenState, Sheet } from '@veltra/sheet-core/core/sheet'
