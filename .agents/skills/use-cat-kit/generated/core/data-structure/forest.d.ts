 ...
 */
interface IForestNode<T extends Obj = Obj, Self = IForestNode<T, unknown>> extends ITreeNode<
  T,
  Self
> {
  /** 所属森林实例 */
 ...
 * 节点创建函数类型
 */
type ForestNodeCreator<T extends Obj, Node extends Obj> = (
  data: T,
  index: number,
  depth: number,
